...
{
    internal class cls_16_ButtonCablesFromCT
    {
        public static void ButtonCablesFromCT(
            string projectCode,
            string excelPath,
            string projectUnits
        )
        {
            ...
            cls_16_MainCablesFromCT mainProcess = new cls_16_MainCablesFromCT();
            // Obtener el resultado del proceso
            ProcessResult processResult =
                mainProcess.MainCablesFromCt(projectCode, excelPath, projectUnits);
            ...
            // Mensaje
            MessageBox.Show("CablesFromCT process has completed successfully." +
