...
{
    internal class cls_16_MainCablesFromString
    {
        public ProcessResult MainCablesFromString(
            string projectCode,
            string excelPath,
            string projectUnits
        )
                ...
                using (Transaction tr = db.TransactionManager.StartTransaction())
                {
                    try
                    {
                        ...
                        int? totalLabelsCreated = 
                            cls_16_ProcessCablesFromStr.ProcessCablesFromString(ed, db, tr, btr, excelPath, projectUnits);
                        // Validamos
        ...
        private void SendMetrics(int totalFiles, int labelsExported, string projectCode)
        {
            ...
            string processLabelsCreation = "696e04dea266bb4378c54d36";
