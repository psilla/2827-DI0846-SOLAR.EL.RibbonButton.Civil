...
namespace SOLAR.EL.RibbonButton.Autocad.Buttons
{
    public class cls_14_ButtonCreateLabelsFromExcel
    {
        ...
        public static void ButtonCreateLabelsFromExcel()
        {
            ...
            // Procesar el Main
            cls_14_MainCreateLabelsFromExcel mainProcess = 
                new cls_14_MainCreateLabelsFromExcel();
            // Obtener el resultado del proceso
            ProcessResult processResult =
                mainProcess.MainCreateLabelsFromExcel(projectCode);
            ...
            // Mensaje
            MessageBox.Show("CreateLabelsFromExcel process has completed successfully." +
